            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8 md:mb-12">
                ...
                <p className="text-base md:text-lg text-gray-600">
                  Join thousands of medical professionals and patients who trust
                  our platform
                </p>
              </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12 md:mb-16">
                ...
                <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">
                  ...
                  management, designed for both medical professionals and
                  patients.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-base md:text-xl text-blue-100 mb-6 md:mb-8">
                Join our platform and experience professional healthcare
                management today.
              </p>
